...
finalParser.add_argument('-i', '--ipaddress', action='store', dest='ip_address', metavar='[Desired IP Address]', type=str, required=True, help="Enter desired IPv4 address")
...
finalParser.add_argument('-q', '--question', action='store', dest='function_number', metavar='[Desired Function Number]', type=int, required=True, help="1 = get_response function, 2 = parse_string function, 3 = parse_header function, 4 = parse_json function, 5 = socket_client function")
