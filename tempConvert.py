...
# second script in the functions' lab ' Temp Conversion'
...
# since we imported the module, we can pass the user input as an argument to the convert temp function, and wrap it
# in a print stateement.
