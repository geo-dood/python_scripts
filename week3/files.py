...
print(
    "^ Here, the len() function is counting the amount of characters in the /etc/passwd file when read as a single string")
print(
    "***Use this when you want to view your file as a single string, or to view the total amount of characters in the file***")
print()
...
print(
    "^ Here, the len() function is counting the amount of items (strings) in the list version of our /etc/passwd file. This is also the amount of lines in the file.")
print(
    "***Use this when you want to end up with a separated list of items. Each line will generate an item in the created list. \n Can be converted to string format - can be used in for loops, as well***")
print()
